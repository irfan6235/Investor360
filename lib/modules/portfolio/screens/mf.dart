...
class MfScreen extends StatefulWidget {
  ...
  @override
  State<MfScreen> createState() => _MfScreenState();
}
...
class _MfScreenState extends State<MfScreen> {
  ...
  void initState() {
    super.initState();
    portfolioController.textEditingControllerBeneidMF = TextEditingController();
    portfolioController.textEditingControllerBeneidMF.clear();
    controllerBottomSheet.resetSelection();
    portfolioController.searchBarMFController.clear();
    FocusManager.instance.primaryFocus?.unfocus();

    portfolioController.textEditingControllerBeneidMF.text = 'All';

    //  portfolioController.filterHoldingsByDPIDAndClientID("ALL", "ALL", "MUTUAL_FUNDS");
  ...
  Future<void> loadDataIfNeeded() async {
    portfolioController.filterHoldingsByDPIDAndClientID(
        "ALL", "ALL", "MUTUAL_FUNDS");
    if (!portfolioController.isMfDataLoaded.value) {
    ...
    return Obx(() {
      if (portfolioController.isLoading.value) {
        ...
        List<HoldingDataList> equityHoldings = portfolioController
            .filteredHoldings
            .where((holding) => holding.securityType == "MUTUAL_FUNDS")
            .toList();
                  ...
                  child: Stack(
                    children: [
                      GestureDetector(
                        onTap: () {
                          Get.bottomSheet(
                            MyBottomSheetPortfolio("MUTUAL_FUNDS"),
                            ...
                            if (value != null) {
                              ...
                              portfolioController.searchBarMFController.clear();
                              portfolioController.textEditingControllerBeneidMF
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                formatNumber(
                                    portfolioController.mFValuePortfolio.value),
                                style: TextStyle(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () async {
                                      controllerBottomSheet.resetSelection();
                                      portfolioController.searchBarMFController
                                          .clear();
                                      portfolioController
                                          .textEditingControllerBeneidMF
                                          .text = 'All';
                      ...
                      children: [
                          ...
                          children: [
                            Flexible(
                              ...
                              child: TextField(
                                controller:
                                    portfolioController.searchBarMFController,
                                // onChanged: searchFilterHoldings,
                                onChanged:
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if (item.securityType == "MUTUAL_FUNDS") {
