...
class DebtState extends State<Debt> {
  ...
  void initState() {
    super.initState();
    portfolioController.textEditingControllerBeneidDebt =
        TextEditingController();
    portfolioController.textEditingControllerBeneidDebt.clear();

    controllerBottomSheet.resetSelection();
    portfolioController.searchBarDebtController.clear();
    FocusManager.instance.primaryFocus?.unfocus();

    portfolioController.textEditingControllerBeneidDebt.text = 'All';

    // portfolioController.fetchNsdlHoldingDataApiPortfolio();
    // portfolioController.filterHoldingsByDPIDAndClientID("ALL", "ALL", "DEBT");
  ...
  Future<void> loadDataIfNeeded() async {
    portfolioController.filterHoldingsByDPIDAndClientID("ALL", "ALL", "DEBT");
    if (!portfolioController.isDebtDataLoaded.value) {
    ...
    return Obx(() {
      if (portfolioController.isLoading.value) {
        ...
        List<HoldingDataList> equityHoldings = portfolioController
            .filteredHoldings
            .where((holding) => holding.securityType == "DEBT")
            .toList();
                        ...
                        onTap: () {
                          Get.bottomSheet(
                            ...
                            if (value != null) {
                              ...
                              portfolioController.searchBarDebtController
                                  .clear();
                              portfolioController
                                  .textEditingControllerBeneidDebt
